...
import { deleteMeetingRoom, meetingRoomList } from "@/pages/api";
...
const MeetingRoomManage = () => {
  ...
  const [resetTable, ResetTable] = useState(0);
  ...
  const searchMeetingRoom = useCallback(async (values: SearchMeetingRoom) => {
    const _data = await meetingRoomList(
      values.name,
      values.capacity,
      values.equipment,
      pageNo,
  ...
  }, [pageNo, pageSize, resetTable]);

  return (
    <div className={styles.container}>
      <div className={styles.meetingRoomManageForm}>
        <Form
          form={form}
        ...
        >
          ...
          <Form.Item label=" " className={styles.handle}>
